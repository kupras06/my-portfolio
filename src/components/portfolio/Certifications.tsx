				...
				<div class="grid gap-4">
					{certifications.map((cert, index) => (
						<motion.a
							...
							viewport={{ once: true }}
							class="group flex items-center gap-4 p-5 bg-background border border-border rounded-lg hover:shadow-card-hover hover:border-accent/50 transition-all duration-300"
						>
